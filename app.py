...
st.markdown("<div style='text-align: center; color: grey; font-size: 20px; margin-top: 30px;'>© 2026 - Bản quyền thuộc UBND Phường Tân Phong</div>", unsafe_allow_html=True)
